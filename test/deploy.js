...
async function getAccounts() {
    const [owner, community, curation, alice, bob, david] = await ethers.getSigners();
}
...
async function deployCommitteeContract(owner, nut) {
    ...
    let contract = await factory.deploy(owner, nut.address);
...
async function deployCommunityFactoryContract(Committee) {
    let factory = new ethers.getContractFactory();
