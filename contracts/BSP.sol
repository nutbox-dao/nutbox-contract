...
contract BSP is Ownable, AccessControlEnumerable, ERC20Burnable {
    ...
    event SteemToBSP(string steemAccount, address indexed to, uint256 indexed amount);
    event BSPToSteem(string steemAccount, address indexed to, uint256 indexed amount);
